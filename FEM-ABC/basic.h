...
#define ABSSQR(x) cabs(x)*cabs(x)

/** @brief Compute the absolute value @f$|x|@f$ of a field element @f$x@f$. */
#define ABS(x) cabs(x)

/**check!!! @brief Compute the sign @f$\mathop{\rm sgn}(x)@f$ of a field element @f$x@f$. */
...
INLINE_PREFIX int _h2_intmax(int a, int b) __attribute__((unused,const));
INLINE_PREFIX int _h2_intmax3(int a, int b, int c) __attribute__((unused,const));
INLINE_PREFIX int _h2_intmin(int a, int b) __attribute__((unused,const));
INLINE_PREFIX int _h2_intmin3(int a, int b, int c) __attribute__((unused,const));
#endif
...
#define allocmem(sz) _h2_allocmem(sz)
/** @brief Allocate heap storage.
 *
 *  @param sz Number of bytes.
...
/** @brief Allocate heap storage of type @ref int.
 *
 *  @param sz Number of @ref int variables.
 *  @returns Pointer to <tt>sz</tt> variables of type @ref int. */
#define allocint(sz) _h2_allocint(sz)
/** @brief Allocate heap storage of type @ref int.
 *
 *  @param sz Number of @ref int variables.
 *  @param filename Name of source file (used for error messages).
...
#define allocreal(sz) _h2_allocreal(sz)
/** @brief Allocate heap storage of type @ref real.
 *
 *  @param sz Number of @ref real variables.
 *  @param filename Name of source file (used for error messages).
...
#define allocfield(sz) _h2_allocfield(sz)
...
#define allocmatrix(rows,cols) _h2_allocmatrix(rows,cols)
...
HEADER_PREFIX void
_h2_heapsort(int n, int leq(int, int, void *), void swap(int, int, void *),
	     void *data);
